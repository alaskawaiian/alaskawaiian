...
import '../../format.dart';
import '../../job/data/job_database.dart';
import '../../job/domain/job.dart';
import '../data/entry_database.dart';
...
class EntriesViewModel {
  EntriesViewModel({required this.entryDatabase, required this.jobDatabase});

  final EntryDatabase entryDatabase;
  final JobDatabase jobDatabase;

  /// combine List<Job>, List<Entry> into List<EntryJob>
  Stream<List<EntryJob>> get _allEntriesStream => CombineLatestStream.combine2(
        entryDatabase.entriesStream(),
        jobDatabase.jobsStream(),
