...
import '../source/isolate_mixin_helpers.dart';
...
abstract class VideosSourceController {
  ...
  Future<MuxedStreamInfo> getVideoInfoFromVideoModel(String videoId) async {
    ...
    AudioOnlyStreamInfo audioInfo = streamInfo.audioOnly.withHighestBitrate();
    VideoOnlyStreamInfo videoInfo = streamInfo.videoOnly.withHighestBitrate();
